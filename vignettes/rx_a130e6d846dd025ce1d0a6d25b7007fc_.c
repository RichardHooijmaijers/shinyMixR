...
extern void rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr();



// prj-specific differential eqns
void rx_a130e6d846dd025ce1d0a6d25b7007fc__dydt(unsigned int _neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double 
		depot,
	ka,
...
void rx_a130e6d846dd025ce1d0a6d25b7007fc__calc_jac(unsigned int _neq, double t, double *__zzStateVar__, double *__PDStateVar__, unsigned int __NROWPD__) {
  _jac_counter_inc();
}
// Functional based initial conditions.
void rx_a130e6d846dd025ce1d0a6d25b7007fc__inis(SEXP _ini_sexp){
...
void rx_a130e6d846dd025ce1d0a6d25b7007fc__calc_lhs(double t, double *__zzStateVar__, double *_lhs) {
double 
		__DDtStateVar_0__,
	__DDtStateVar_1__,
	depot,
...
extern SEXP rx_a130e6d846dd025ce1d0a6d25b7007fc__model_vars(){
	...
	SET_STRING_ELT(mmd5,0,mkChar("4f3120edee22c4c0b24cdb74d578fbd1"));
	SET_STRING_ELT(mmd5n,1,mkChar("parsed_md5"));
	SET_STRING_ELT(mmd5,1,mkChar("a130e6d846dd025ce1d0a6d25b7007fc"));
	SET_STRING_ELT(trann,0,mkChar("jac"));
	SET_STRING_ELT(tran,0,mkChar("fullint"));
	SET_STRING_ELT(trann,1,mkChar("prefix"));
	SET_STRING_ELT(tran, 1,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__"));
	SET_STRING_ELT(trann,2,mkChar("dydt"));
	SET_STRING_ELT(tran, 2,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__dydt"));
	SET_STRING_ELT(trann,3,mkChar("calc_jac"));
	SET_STRING_ELT(tran, 3,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__calc_jac"));
	SET_STRING_ELT(trann,4,mkChar("calc_lhs"));
	SET_STRING_ELT(tran, 4,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__calc_lhs"));
	SET_STRING_ELT(trann,5,mkChar("model_vars"));
	SET_STRING_ELT(tran, 5,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__model_vars"));
	SET_STRING_ELT(trann,6,mkChar("ode_solver"));
	SET_STRING_ELT(tran, 6,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver"));
	SET_STRING_ELT(trann,7,mkChar("ode_solver_sexp"));
	SET_STRING_ELT(tran, 7,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_sexp"));
	SET_STRING_ELT(trann,8,mkChar("ode_solver_0_6"));
	SET_STRING_ELT(tran, 8,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6"));
	SET_STRING_ELT(trann,9,mkChar("ode_solver_focei_eta"));
	SET_STRING_ELT(tran, 9,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_focei_eta"));
	SET_STRING_ELT(trann,10,mkChar("ode_solver_ptr"));
	SET_STRING_ELT(tran, 10,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr"));
	SET_STRING_ELT(trann,11,mkChar("inis"));
	SET_STRING_ELT(tran, 11,mkChar("rx_a130e6d846dd025ce1d0a6d25b7007fc__inis"));
...
extern void rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver(
                    int *neq,
                    double *theta,      //order:
                    double *time,
                    int *evid,
  ...
  rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr();
  _old_c(neq, theta, time, evid, ntime, inits, dose, ret, atol, rtol, stiff, transit_abs, nlhs, lhs, rc);
}

void rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6(int *neq,
                        double *theta,  //order:
                        double *time,
                        int *evid,
                        int *ntime,
...
extern void rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr  (){
  _assign_fn_pointers(rx_a130e6d846dd025ce1d0a6d25b7007fc__dydt , rx_a130e6d846dd025ce1d0a6d25b7007fc__calc_lhs , rx_a130e6d846dd025ce1d0a6d25b7007fc__calc_jac, rx_a130e6d846dd025ce1d0a6d25b7007fc__inis, 2 , 22,
#ifdef __DEBUG__
                      1
#else
                      0
...
extern SEXP rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_sexp (// Parameters
                                 SEXP sexp_theta,
                                 SEXP sexp_inits,
                                 SEXP sexp_lhs,
				 // Events
...
static R_NativePrimitiveArgType rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solverrx_t[] = {
...
static R_NativePrimitiveArgType  rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6rx_t[] = {
  //*neq, *theta, *time,  *evid, *ntime, *inits,   *dose,   *ret,     *atol,  *rtol,   *stiff, *transit_abs, *nlhs, *lhs, *rc
...
void R_init_rx_a130e6d846dd025ce1d0a6d25b7007fc_ (DllInfo *info){
  ...
  R_RegisterCCallable("rx_a130e6d846dd025ce1d0a6d25b7007fc_","rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver",       (DL_FUNC) rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver);
  R_RegisterCCallable("rx_a130e6d846dd025ce1d0a6d25b7007fc_","rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_sexp",  (DL_FUNC) rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_sexp);
  R_RegisterCCallable("rx_a130e6d846dd025ce1d0a6d25b7007fc_","rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6",   (DL_FUNC) rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6);
  R_RegisterCCallable("rx_a130e6d846dd025ce1d0a6d25b7007fc_","rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr",   (DL_FUNC) rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr);

  /* R_registerRoutines(info, NULL, NULL, NULL, NULL); */
  /* R_useDynamicSymbols(info,TRUE); */

  static const R_CMethodDef cMethods[] = {
    {"rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver", (DL_FUNC) &rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver, 15, rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solverrx_t},
    {"rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6", (DL_FUNC) &rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6, 21, rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_0_6rx_t},
    {NULL, NULL, 0, NULL}
  };
  
  R_CallMethodDef callMethods[]  = {
    {"rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr", (DL_FUNC) &rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_ptr, 0},
    {"rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_sexp", (DL_FUNC) &rx_a130e6d846dd025ce1d0a6d25b7007fc__ode_solver_sexp, 23},
    {"rx_a130e6d846dd025ce1d0a6d25b7007fc__model_vars", (DL_FUNC) &rx_a130e6d846dd025ce1d0a6d25b7007fc__model_vars, 0},
    {"rx_a130e6d846dd025ce1d0a6d25b7007fc__inis", (DL_FUNC) &rx_a130e6d846dd025ce1d0a6d25b7007fc__inis, 1},
    {NULL, NULL, 0}
  };
